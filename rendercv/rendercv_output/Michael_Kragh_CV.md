...
- Location: Denmark
- GitHub: [codemikemike](https://github.com/codemikemike)
...
# Skills
**Backend:** C#, .NET, ASP.NET Core, REST APIs, Blazor

**Database:** SQL Server, MySQL, Entity Framework, Dapper

**DevOps:** Docker, GitHub Actions, CI/CD, Git

**Architecture:** Clean Architecture, Repository Pattern, SOLID, Testing
